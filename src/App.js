...
import SpecVariants from './components/SpecVariants';
    ...
    <div className="App">
      ...
      <NavBar />            
        <Switch>
          ...
          <Route component={SpecVariants} path="/specvariants" /> 
          <Route component={Cars} path="/cars" /> 
          <Route component={CarSpec} path="/carspec" />          
          ...
          <Route component={Products2} path="/products2" exact />          
          <Route component={Products2} path="/products2/:cid" />       
          <Route component={Details} path="/details/:varid" />
          <Route component={SpecDetails} path="/specdetails/:varid" />                 
          ...
          <Route component={ForgotPwd} path="/forgot" />  
