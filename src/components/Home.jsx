    ...
    <div className="row">
      ...
      <div className="col-md-4">
        <div className="product-item">
          <a href="offers.html"><img src="images\offer-1.jpg" alt /></a>
          <div className="down-content">
            <a href="offers.html"><h4>Maruti Suzuki Dzire</h4></a>
            <h6><small>for</small> Rs120 <small>per hour</small></h6>
      ...
      <div className="col-md-4">
        <div className="product-item">
          <a href="offers.html"><img src="\images\offer-2.jpg" alt /></a>
          <div className="down-content">
            <a href="offers.html"><h4>Hyundai Elite i20 </h4></a>
            <h6><small>for</small> Rs150 <small>per hour</small></h6>
            <h4>Book Your drive now!</h4>
          </div>
        </div>
      </div>
      <div className="col-md-4">
        <div className="product-item">
          <a href="offers.html"><img src="\images\offer-3.jpg" alt /></a>
          <div className="down-content">
            <a href="offers.html"><h4>Mahindra Thar</h4></a>
            <h6><small>for</small> Rs250 <small>per hour</small></h6>
            <h4>Book Your drive now!</h4>
          </div>
        </div>
      </div>
