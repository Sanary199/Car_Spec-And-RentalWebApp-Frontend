...
const SpecVariants = () => {
  ...
  const loadData = () => {
    axios.get(BASE_URL + 'api/specvariants').then((resp) => {
      console.log(resp.data)
      setData(resp.data)
    })
  }
  ...
  const handleDelete = (id) => {
    ...
    if (result) {
      axios.delete(BASE_URL + 'api/specvariants/' + id).then((resp) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit) {
      axios
        .put(BASE_URL + 'api/specvariants/' + id, formData)
        .then((resp) => {
          toast.success(resp.data)
          setProduct({
            title: '',
      ...
      axios
        .post(BASE_URL + 'api/specvariants', formData)
        .then((resp) => {
          toast.success(resp.data)
          setProduct({
            title: '',
